...
- jul 21 2024
  - initial version, schematics updated, not yet verified in hardware!
- sep 25 2024
  - DevBoard PCB's are verified and ready to ship
...
- sep 26 2024
  - The directory TULIP4041-RP2040-Final contains the archived 2040 sources and the latest binary (.uf2)
- sep 26 2024
  - The direcory TULIP-P2 contains the sources and build for the RP2350 version
- oct 11 2024
  - BOM adapted, line 11, R6 must be 200k resistor (pulldown)
  - added component references
- oct 21 2024
  - I mussed have messed up something. Source directory is deleted and will be up when fixed
...
- oct 24 2024
  - new firmware file "tulip4041_00.01.04B-Pico2.uf2" uploaded
  ...
  - REAME.md edited, figured out how to nest lists
