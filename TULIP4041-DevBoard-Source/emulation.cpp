...
bool HP82153A_active = false;               // HP82153A Wand active, also used SELP9
...
void __not_in_flash_func(core1_pio)()
{
    ...
    while(1)
    {
        ...
        // if there was a previous TraceBuffer overflow, add this to to the instruction msb
