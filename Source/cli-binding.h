...
#define XMEM_HELP_TXT "Extended Memory functions\r\n\
        ...
        ERASE         erase all Extended Memory, do NOT use when memory is plugged\r\n"
...
#define UMEM_HELP_TXT "User Memory functions\r\n\
        status        shows the User Memory status\r\n\
        [N]           N=0..4\r\n\
                      plugs N User Memory modules (0..4), 4 is a Quad Memory Module\r\n\
                      be careful of conflicts with physical User Memory Modules or the HP41CV/CX\r\n\
        dump          creates a dump of User Memory\r\n\
        ERASE         erase all User Memory, do NOT use when memory is plugged\r\n"
...
#define EXPORT_HELP_TXT "export functions\r\n\
        ...
        [filename] [new_filename]    export a single file to a new file on the uSD card\r\n\
                                     the new filename can contain an existing subdirectory name\r\n\
                                     existing files will NOT be overwritten\r\n"
...
#define QROM_HELP_TXT "QROM functions for FRAM\r\n\
        ...
        wprot p       toggle the write protection of all banks of the QROM in Page p (hex)\r\n\
...
#define cd_directory            1               // change to the given directory
#define cd_root                 2               // change to the root directory
#define cd_status               3               // show the current working directory
...
#define CD_HELP_TXT "Change Working Directory functions\r\n\
        ...
        The directory must exist and TULIP firmware supports only one directory level\r\n"
...
#define LIST_HELP_TXT "list functions\r\n\
        ...
        <flash/qrom>      flash - list only files in FLASH\r\n\
          <ext> <all>     qrom  - list only files in QROM/ FRAM\r\n\
...
#define HEPRAM_HELP_TXT "HEPRAM functions\r\n\
        ...
        ramtog p      toggle the write protect bit for the HEPRAM Page p (hex)\r\n\
                      write protecting a Page in the HEPRAM chain will lead to undesired effects!\r\n\
...
#define WAND_HELP_TXT "wand functions\r\n\
        ...
        send              send up to 8 barcodes (decimals 0..255 or hex 0x..) to the HP41 via the Wand emulation\r\n\
                           example : wand send 123 23 46 7 0x2E\r\n\
                          WARNING: do not send ALPHA strings with chards <0x10 when not in PRGM mode!\r\n\
        sendx             like send, but with hex digits only \r\n\
                           example : wand sendx 7B 17 2E 07 E6\r\n"
...
// ROM plug and unplug functions
  ...
  extern void uif_qrom(int i, int p, int b);            // QROM functions
  extern void uif_hepram(int i, int p);                 // HEPRAM functions
