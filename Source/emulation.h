...
#define PowerMode_Undefined   0
#define PowerMode_Running     1
#define PowerMode_LightSleep  2
#define PowerMode_DeepSleep   3
...
struct PLine {
    ...
    uint8_t         prev_mode;      // previous power mode                        4 bytes      8
    uint8_t         new_mode;       // new power mode                             4 bytes     12
    absolute_time_t t_start;        // start time of this event                  8 bytes     20
    absolute_time_t t_end;          // end time of this event                    8 bytes     28
};
