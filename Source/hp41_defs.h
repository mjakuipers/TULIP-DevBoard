...
#define inst_HEPROMBLK  0x830                   // HEPAX ROMBLK with SYNC bit set
#define inst_HEPWPTOG   0x9F0                   // HEPAX WPTOG with SYNC bit set
...
#define inst_PBSY      0xFAC                   // set carry if FI 0 set with SYNC bit
#define inst_WNDB      0xE2C                   // set carry if DATA in Wand Buffer (FI 2 set) with SYNC bit
...
#define SELP9_POWON     0x083                 // 0x043, set carry if printer is ON, no SYNC bit!
#define SELP9_VALID     0x043                 // 0x083, set carry if status valid, no SYNC bit!
