...
void sleep_goto_dormant_until_pin(uint gpio_pin, bool edge, bool high) {
    ...
    // we need to disable the regular PWO interrupt
    gpio_set_irq_enabled_with_callback(gpio_pin, GPIO_IRQ_EDGE_RISE | GPIO_IRQ_EDGE_FALL, false, &pwo_callback);
    ...
    // enable the PWO callback again
    gpio_set_irq_enabled_with_callback(gpio_pin, GPIO_IRQ_EDGE_RISE | GPIO_IRQ_EDGE_FALL, true, &pwo_callback);
...
// rosc_enable implemented here for now pending an SDK update
